...
const AuthorizeUrlForWebsite = 'https://open.work.weixin.qq.com/wwopen/sso/qrConnect'
...
OAuth.prototype.getAuthorizeUrlForWebsite = function(options) {
  const params = {}
  params['appid'] = this._corpId
  if (!options.agentId) {
    throw new Error('Wechat Enterprise getAuthorizeUrlForWebsite require \'agentId\' option')
  }
  ...
  return AuthorizeUrlForWebsite + '?' + querystring.stringify(params)
}
